...
public final class Guise {
	...
	public static final URI GUISE_WEB_URI = URI.create("https://guise.io/framework/");
	...
	public static final URI NAMESPACE_URI = URI.create("https://guise.io/framework/namespaces/guise/");
